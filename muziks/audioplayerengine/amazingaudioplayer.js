    ...
    $.fn.amazingaudioplayer = function(options) {
        ...
        var PlayerSkin = function(amazingPlayer, container, options, id) {
            ...
            var formatSeconds = function(secs) {
                ...
                if (instance.options.customtimestyle) return instance.options.timestyle.replace("%HOURS%", hours).replace("%MINUTES%",
                    minutes).replace("%SECONDS%", seconds);
            ...
            if (this.options.showimage) {
                ...
                this.container.on("amazingaudioplayer.updateinfo", function(event, data) {
                    if (data.image.length > 0) instance.$image.html("<div class='amazingaudioplayer-image-space' style='display:inline-block;vertical-align:middle;height:100%;'></div><img alt='" + amEscapeHtml(data.title) + "' src='" + data.image + "' style='width:100%;max-width:100%;vertical-align:middle;' />");
            ...
            if (this.options.showtitle ||
                ...
                if (this.options.showinfo) {
                    ...
                    this.container.on("amazingaudioplayer.updateinfo", function(event, data) {
                        ...
                        var t =
                            instance.options.infoformat.replace(/%TITLE%/g, data.title);
                        t = t.replace(/%ALBUM%/g, data.album);
                        t = t.replace(/%ARTIST%/g, data.artist);
                        t = t.replace(/%INFO%/g, data.info);
            ...
            this.container.on("amazingaudioplayer.paused",
            ...
            this.container.on("amazingaudioplayer.stopped", function(event, currentItem) {
                ...
                if (instance.options.enablega && instance.options.gatrackingid && window.ga) ga("send",
                    "event", instance.options.gacategory, "stop", instance.amazingPlayer.elemArray[currentItem].title, instance.options.gaeventvalue)
            });
            ...
            if (this.options.showtitleinbar) {
                this.$bartitle =
                    $("<div class='amazingaudioplayer-bar-title'></div>");
                ...
                this.container.on("amazingaudioplayer.updateinfo", function(event, data) {
                    ...
                    if (instance.options.titleinbarscroll) {
                        instance.bartitlewidth =
                            instance.$bartitletext.width();
            ...
            if (this.options.showinfoinbar) {
                ...
                this.container.on("amazingaudioplayer.updateinfo", function(event, data) {
                    ...
                    instance.$barinfotext = $("<span class='amazingaudioplayer-bar-info-text'>" +
                        t + "</span>");
            ...
            if (this.options.showtracklist) {
                ...
                for (var i = 0; i < this.amazingPlayer.elemLength; i++) {
                    ...
                    if (!isTouch || !instance.options.disablehoverontouch) $track.hover(function() {
                        ...
                        if ($(this).data("order") !=
                            instance.amazingPlayer.currentItem) $(this).removeClass("amazingaudioplayer-track-item-active");
        ...
        FlashHTML5Player.prototype = {
            ...
            play: function(startTime, duration) {
                ...
                if (this.isHtml5) {
                    ...
                    if (promise !==
                        undefined && "catch" in promise) promise["catch"](function() {
                    ...
                    if (startTime > 0 && startTime < duration) this.flashObject.setTime(startTime /
                        duration)
            ...
            getDuration: function() {
                return this.isHtml5 ? this.html5Object.get(0).duration :
                    0
            },
            getSeconds: function() {
            ...
            setPlaybackRate: function(val) {
                if (this.isHtml5) this.html5Object.get(0).playbackRate =
                    val
            }
        };
        ...
        AmazingAudioPlayer.prototype = {
            ...
            processInit: function() {
                ...
                instance.createSkin();
                if (instance.options.saveposincookie) instance.container.on("amazingaudioplayer.playprogress",
                    function(event, data) {
                        var current = isNaN(data.current) ? 0 : data.current;
                ...
                if (instance.options.saveposincookie)
                    if ($.amaudioCookie("amaudiopos-" + instance.id)) {
                        ...
                        if (savedpos && savedpos.length == 2) {
                            firstId = parseInt(savedpos[0]);
                            startTime = parseFloat(savedpos[1]) /
                                1E3
                        }
            ...
            audioRun: function(index, autoPlay) {
                ...
                if (this.elemArray[this.currentItem].live) {
                    ...
                    } else if (this.options.updatelivetitle) this.updateLiveTitle();
            ...
            updateLiveShoutcastByHTML: function() {
                ...
                if (a.prop("port")) src += ":" + a.prop("port");
                src += "/played";
                if (instance.options.shoutcastcustomplayedurl && instance.options.shoutcastcustomplayedurl.length > 0) src = instance.options.shoutcastcustomplayedurl;
                var args = {
                    type: "POST",
                    data: {
            ...
            updateLiveRadionomy: function() {
                ...
                clearTimeout(instance.liveUpdateTimeout);
                instance.liveUpdateTimeout = null;
                var src = "https://api.radionomy.com/currentsong.cfm?radiouid=" +
                    this.elemArray[this.currentItem].radionomyradiouid + "&type=xml&cover=yes&callmeback=yes&defaultcover=yes&dynamicconf=yes";
                $.ajax({
                    type: "GET",
                    url: src,
                    dataType: "xml"
                    ...
                    if (tracks && tracks.length > 0) {
                        ...
                        if (track && track.length > 0) {
                            ...
                            if (artist &&
                                artist.length > 0) instance.elemArray[instance.currentItem].artist = artist;
                ...
                if (instance.options.showliveplayedlist && (typeof wonderplugin_audio_ajaxobject != "undefined" || instance.options.radionomyservice)) {
                    ...
                    $.ajax(args).done(function(data) {
                        if (data) {
                            var playedlist = '<div class="amazingaudioplayer-playedlist-title">' + instance.options.playedlisttitle + "</div>";
                            var count =
                                Math.min(instance.options.maxplayedlist, data.length);
                            if (instance.options.addwm && count > 2) count = 2;
                            playedlist += '<ul class="amazingaudioplayer-playedlist">';
                            for (var i = 0; i < count; i++) {
                                ...
                                var text = "";
                                if (image) text += '<div class="amazingaudioplayer-playedlist-item-radionomy-image"><img src="' + image + '" alt="' + amEscapeHtml(title) + '" width="' + instance.options.playedlistimagewidth + '" height="' +
                                    instance.options.playedlistimageheight + '"></div>';
                                ...
                                if (i == 0) {
                                    ...
                                    if (artist) instance.elemArray[instance.currentItem].artist =
                                        artist;
            ...
            checkMK: function() {
                if (this.options.vm == "AMF" + "ree") {
                    ...
                    if (mklink.length < 0 || mklink.text().indexOf(this.options.pvm) < 0 || mklink.attr("href") !== this.options.lvm) this.container.append('');
                    else {
                ...
                switch (this.options.loop) {
                    case 0:
                        if (!this.options.noncontinous &&
                            this.currentItem < this.elemLength - 1) this.audioRun(-1, true);
                        else this.stopAudio();
                        break;
                    case 1:
        ...
        for (var key in options)
            ...
            if (this.options.skinsfolder.length > 0 && this.options.skinsfolder[this.options.skinsfolder.length -
